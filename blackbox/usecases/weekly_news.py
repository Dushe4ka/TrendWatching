...
def analyze_trend(
    ...
    try:
        ...
        if total_tokens <= max_context_size * 0.8:
            ...
            main_news_prompt = f"""
            Analyze the following materials from the last week in the category {category}:
        ...
        final_prompt = f"""
        Based on the following analyses of individual material parts, create a unified weekly news summary for the last week in the category {category}.
        ...
        📆 News Summary — {category} ({analysis_start_date} - {end_date})
        ...
        📊 General Trends:
        [List of key trends identified over the week]
